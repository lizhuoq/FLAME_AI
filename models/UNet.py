...
class CropAndConcat(nn.Module):
    ...
    def __init__(self, channels) -> None:
        super().__init__()
        self.conv = DoubleConvolution(channels * 5, channels * 20)
...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.middle_conv = DoubleConvolution(64 * configs.seq_len * scale, 128 * configs.pred_len * scale)
        ...
        self.concat = nn.ModuleList([CropAndConcat(i * scale) for i in [64, 32, 16, 8]])
